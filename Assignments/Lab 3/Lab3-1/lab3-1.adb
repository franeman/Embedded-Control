...
F:G$Steering_Servo$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Llab3_1.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:Llab3_1.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$SERVO_PW_CENTER$0$0({2}SI:U),E,0,0
S:G$SERVO_PW_RIGHT$0$0({2}SI:U),E,0,0
S:G$SERVO_PW_LEFT$0$0({2}SI:U),E,0,0
...
S:Llab3_1.Set_Pulsewidth$input$1$60({1}SC:U),R,0,0,[r7]
S:Llab3_1.Steering_Servo$input$1$63({1}SC:U),R,0,0,[r7]
...
S:Flab3_1$__str_0$0$0({41}DA41d,SC:S),D,0,0
S:Flab3_1$__str_1$0$0({14}DA14d,SC:S),D,0,0
