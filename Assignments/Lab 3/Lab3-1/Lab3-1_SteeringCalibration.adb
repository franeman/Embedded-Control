...
S:LLab3_1_SteeringCalibration.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:LLab3_1_SteeringCalibration.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$PW_CENTER$0$0({2}SI:U),E,0,0
S:G$PW_RIGHT$0$0({2}SI:U),E,0,0
S:G$PW_LEFT$0$0({2}SI:U),E,0,0
S:G$SERVO_PW$0$0({2}SI:U),E,0,0
S:LLab3_1_SteeringCalibration.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLab3_1_SteeringCalibration.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLab3_1_SteeringCalibration.Steering_Servo$input$1$62({1}SC:U),R,0,0,[r7]
S:LLab3_1_SteeringCalibration.Turn$input$1$66({1}SC:U),R,0,0,[r7]
...
S:FLab3_1_SteeringCalibration$__str_2$0$0({82}DA82d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_3$0$0({26}DA26d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_4$0$0({125}DA125d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_5$0$0({24}DA24d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_6$0$0({126}DA126d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_7$0$0({25}DA25d,SC:S),D,0,0
S:FLab3_1_SteeringCalibration$__str_8$0$0({52}DA52d,SC:S),D,0,0
