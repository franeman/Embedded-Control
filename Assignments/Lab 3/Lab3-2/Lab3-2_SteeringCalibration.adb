...
S:LLab3_2_SteeringCalibration.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:LLab3_2_SteeringCalibration.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:LLab3_2_SteeringCalibration.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:LLab3_2_SteeringCalibration.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
F:G$Turn$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CalibrateSteering$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LLab3_2_SteeringCalibration.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:LLab3_2_SteeringCalibration.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLab3_2_SteeringCalibration.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLab3_2_SteeringCalibration.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:LLab3_2_SteeringCalibration.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:LLab3_2_SteeringCalibration.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:LLab3_2_SteeringCalibration.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:LLab3_2_SteeringCalibration.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:LLab3_2_SteeringCalibration.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:LLab3_2_SteeringCalibration.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:LLab3_2_SteeringCalibration.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:LLab3_2_SteeringCalibration.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
S:G$PW_CENTER$0$0({2}SI:U),E,0,0
S:G$PW_RIGHT$0$0({2}SI:U),E,0,0
S:G$PW_LEFT$0$0({2}SI:U),E,0,0
S:G$SERVO_PW$0$0({2}SI:U),E,0,0
S:LLab3_2_SteeringCalibration.Steering_Servo$input$1$129({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.Turn$input$1$133({1}SC:U),R,0,0,[r7]
S:LLab3_2_SteeringCalibration.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:FLab3_2_SteeringCalibration$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_3$0$0({39}DA39d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_4$0$0({16}DA16d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_5$0$0({83}DA83d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_6$0$0({127}DA127d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_7$0$0({126}DA126d,SC:S),D,0,0
S:FLab3_2_SteeringCalibration$__str_8$0$0({51}DA51d,SC:S),D,0,0
