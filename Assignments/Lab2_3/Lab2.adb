...
S:LLab2.Mode_One$ADC_Value$1$102({2}SI:U),E,0,0
...
S:LLab2.Mode_One$Error$1$102({1}SC:U),E,0,0
S:LLab2.Mode_One$rounds$1$102({1}SC:U),R,0,0,[]
S:LLab2.Draw_Bar$length$1$154({1}SC:U),R,0,0,[r7]
S:LLab2.Draw_Bar$i$1$155({1}SC:U),R,0,0,[r6]
S:LLab2.SetAllLEDs$sloc0$1$0({1}SX:U),E,0,0
S:LLab2.LightNumLEDs$num$1$166({1}SC:U),R,0,0,[r7]
S:LLab2.CompareVals$expected$1$180({1}SC:U),E,0,0
S:LLab2.CompareVals$input$1$180({1}SC:U),R,0,0,[r7]
...
S:FLab2$__str_5$0$0({659}DA659d,SC:S),D,0,0
