...
S:G$ADC_mapped$0$0({1}SC:U),E,0,0
S:G$desiredValue$0$0({2}SI:S),E,0,0
S:LLab2.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLab2.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLab2.Mode_One$random_Result$1$90({1}SC:U),R,0,0,[r4]
S:LLab2.Mode_One$game_Time$1$90({2}SI:U),R,0,0,[r1,r2]
S:LLab2.Mode_One$total_Score$1$90({2}SI:U),R,0,0,[r6,r7]
S:LLab2.Mode_One$round_Score$1$90({2}SI:U),R,0,0,[r3,r4]
S:LLab2.Mode_One$rounds$1$90({1}SC:U),R,0,0,[]
S:LLab2.Mode_One$ADC_final$1$90({1}SC:U),R,0,0,[r3]
S:LLab2.Mode_Three$round$1$110({1}SC:U),R,0,0,[]
S:LLab2.Draw_Bar$length$1$115({1}SC:U),R,0,0,[r7]
S:LLab2.Draw_Bar$i$1$116({1}SC:U),R,0,0,[r6]
S:LLab2.SetAllLEDs$sloc0$1$0({1}SX:U),E,0,0
S:LLab2.MapADC$low$1$123({1}SC:U),E,0,0
S:LLab2.MapADC$high$1$123({1}SC:U),E,0,0
S:LLab2.MapADC$val$1$123({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:LLab2.LightNumLEDs$num$1$125({1}SC:U),R,0,0,[r7]
S:LLab2.CompareVals$expected$1$140({1}SC:U),E,0,0
S:LLab2.CompareVals$input$1$140({1}SC:U),R,0,0,[r7]
