...
F:G$ADC1_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read_AD_input$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$Compare_Answer$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Flash_Biled$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Flash_LEDs$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_One$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_Two$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_Three$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Draw_Bar$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer0_ISR$0$0({2}DF,SV:S),Z,0,0,1,1,0
F:G$random$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$SetAllLEDs$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$MapADC$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$LightNumLEDs$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ClearTimer0$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SetBILED$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$DebounceButton$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$CompareVals$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$n$0$0({1}SC:U),E,0,0
S:G$round$0$0({2}SI:S),E,0,0
S:G$points$0$0({2}SI:U),E,0,0
S:G$totalPoints$0$0({2}SI:U),E,0,0
S:G$randomNumber$0$0({2}SI:S),E,0,0
S:G$length$0$0({1}SC:U),E,0,0
S:G$ADC_value$0$0({2}SI:U),E,0,0
S:G$error$0$0({2}SI:U),E,0,0
S:G$scaledValue$0$0({2}SI:U),E,0,0
S:G$score$0$0({2}SI:U),E,0,0
S:G$buttonPresses$0$0({2}SI:S),E,0,0
S:G$tmpCount$0$0({2}SI:S),E,0,0
S:G$overflows$0$0({10}DA5d,SI:S),E,0,0
S:G$numLEDs$0$0({2}SI:S),E,0,0
S:G$tries$0$0({2}SI:S),E,0,0
S:LLab2.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLab2.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLab2.Compare_Answer$randomNumber$1$86({1}SC:U),E,0,0
S:LLab2.Compare_Answer$yourAnswer$1$86({2}SI:U),R,0,0,[r6,r7]
S:LLab2.Mode_One$random_Result$1$97({1}SC:U),R,0,0,[r4]
S:LLab2.Mode_One$game_Time$1$97({2}SI:U),R,0,0,[r2,r3]
S:LLab2.Mode_One$total_Score$1$97({2}SI:U),R,0,0,[r6,r7]
S:LLab2.Mode_One$round_Score$1$97({2}SI:U),R,0,0,[r3,r4]
S:LLab2.Mode_One$rounds$1$97({1}SC:U),R,0,0,[]
S:LLab2.Mode_One$ADC_mapped$1$97({1}SC:U),E,0,0
S:LLab2.Mode_One$ADC_final$1$97({1}SC:U),R,0,0,[]
S:LLab2.Draw_Bar$length$1$135({1}SC:U),R,0,0,[r7]
S:LLab2.Draw_Bar$i$1$136({1}SC:U),R,0,0,[r6]
S:LLab2.SetAllLEDs$sloc0$1$0({1}SX:U),E,0,0
S:LLab2.MapADC$low$1$143({1}SC:U),E,0,0
S:LLab2.MapADC$high$1$143({1}SC:U),E,0,0
S:LLab2.MapADC$val$1$143({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:LLab2.LightNumLEDs$num$1$145({1}SC:U),R,0,0,[r7]
S:LLab2.CompareVals$expected$1$160({1}SC:U),E,0,0
S:LLab2.CompareVals$input$1$160({1}SC:U),R,0,0,[r7]
...
S:FLab2$__str_0$0$0({109}DA109d,SC:S),D,0,0
S:FLab2$__str_1$0$0({54}DA54d,SC:S),D,0,0
S:FLab2$__str_2$0$0({54}DA54d,SC:S),D,0,0
S:FLab2$__str_3$0$0({53}DA53d,SC:S),D,0,0
S:FLab2$__str_4$0$0({52}DA52d,SC:S),D,0,0
S:FLab2$__str_5$0$0({643}DA643d,SC:S),D,0,0
S:FLab2$__str_6$0$0({8}DA8d,SC:S),D,0,0
S:FLab2$__str_7$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_8$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_9$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_10$0$0({154}DA154d,SC:S),D,0,0
S:FLab2$__str_11$0$0({20}DA20d,SC:S),D,0,0
S:FLab2$__str_12$0$0({19}DA19d,SC:S),D,0,0
S:FLab2$__str_13$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_14$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_15$0$0({726}DA726d,SC:S),D,0,0
S:FLab2$__str_16$0$0({9}DA9d,SC:S),D,0,0
S:FLab2$__str_17$0$0({28}DA28d,SC:S),D,0,0
S:FLab2$__str_18$0$0({21}DA21d,SC:S),D,0,0
S:FLab2$__str_19$0$0({19}DA19d,SC:S),D,0,0
