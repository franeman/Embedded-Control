...
S:LLab2.Mode_Three$round$1$108({1}SC:U),R,0,0,[]
S:LLab2.Draw_Bar$length$1$113({1}SC:U),R,0,0,[r7]
S:LLab2.Draw_Bar$i$1$114({1}SC:U),R,0,0,[r6]
S:LLab2.SetAllLEDs$sloc0$1$0({1}SX:U),E,0,0
S:LLab2.MapADC$low$1$121({1}SC:U),E,0,0
S:LLab2.MapADC$high$1$121({1}SC:U),E,0,0
S:LLab2.MapADC$val$1$121({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:LLab2.LightNumLEDs$num$1$123({1}SC:U),R,0,0,[r7]
S:LLab2.CompareVals$expected$1$138({1}SC:U),E,0,0
S:LLab2.CompareVals$input$1$138({1}SC:U),R,0,0,[r7]
