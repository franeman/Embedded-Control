...
F:G$Pot_Scaling$0$0({2}DF,SI:U),Z,0,0,0,0,0
...
S:LLab2.Compare_Answer$randomNumber$1$90({1}SC:U),E,0,0
S:LLab2.Compare_Answer$yourAnswer$1$90({2}SI:U),R,0,0,[r6,r7]
S:LLab2.Mode_One$random_Result$1$102({1}SC:U),R,0,0,[r4]
S:LLab2.Mode_One$game_Time$1$102({2}SI:U),R,0,0,[r2,r3]
S:LLab2.Mode_One$total_Score$1$102({2}SI:U),R,0,0,[r6,r7]
S:LLab2.Mode_One$round_Score$1$102({2}SI:U),R,0,0,[r3,r4]
S:LLab2.Mode_One$rounds$1$102({1}SC:U),R,0,0,[]
S:LLab2.Draw_Bar$length$1$157({1}SC:U),R,0,0,[r7]
S:LLab2.Draw_Bar$i$1$158({1}SC:U),R,0,0,[r6]
S:LLab2.SetAllLEDs$sloc0$1$0({1}SX:U),E,0,0
S:LLab2.MapADC$low$1$167({1}SC:U),E,0,0
S:LLab2.MapADC$high$1$167({1}SC:U),E,0,0
S:LLab2.MapADC$val$1$167({1}SC:U),R,0,0,[]
S:LLab2.LightNumLEDs$num$1$169({1}SC:U),R,0,0,[r7]
S:LLab2.CompareVals$expected$1$184({1}SC:U),E,0,0
S:LLab2.CompareVals$input$1$184({1}SC:U),R,0,0,[r7]
...
S:FLab2$__str_5$0$0({635}DA635d,SC:S),D,0,0
S:FLab2$__str_6$0$0({6}DA6d,SC:S),D,0,0
S:FLab2$__str_7$0$0({16}DA16d,SC:S),D,0,0
S:FLab2$__str_8$0$0({16}DA16d,SC:S),D,0,0
S:FLab2$__str_9$0$0({16}DA16d,SC:S),D,0,0
...
S:FLab2$__str_15$0$0({739}DA739d,SC:S),D,0,0
S:FLab2$__str_16$0$0({10}DA10d,SC:S),D,0,0
S:FLab2$__str_17$0$0({45}DA45d,SC:S),D,0,0
S:FLab2$__str_18$0$0({19}DA19d,SC:S),D,0,0
